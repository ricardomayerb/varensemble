...
data_object_per_new <- readRDS("./data/VAR_data_Peru.rds")
print(colnames(data_object_per_new))
target_transformation <- readRDS("./data/target_transformation/target_transformation_Peru.rds")
...
raw_data <- readRDS("./data/raw_VAR_data/raw_VAR_data_Peru.rds")
...
write.xlsx(accumulated_passing_models, file = "./Excel_Output/Peru/All_accumulated_passing_models_Peru_t165_lag_1.xlsx")
...
saveRDS(list(cv_size_2 = cv_size_2_per_row, cv_size_3 = cv_size_3_per_row, 
        ...
        file = "./data/forecast_models/all_peru_models_new_data_all_variables_restricted_combos_t165_lag_1.rds")

...
data_object_per_new <- readRDS("./data/VAR_data_Paraguay.rds")
print(colnames(data_object_per_new))
target_transformation <- readRDS("./data/target_transformation/target_transformation_Paraguay.rds")
...
raw_data <- readRDS("./data/raw_VAR_data/raw_VAR_data_Paraguay.rds")
var_data <- data_object_per_new

colnames(raw_data) <- colnames(var_data)
...
exogenous_variables <- c("ip_us", "ip_asia", "ip_ue", "act_eco_bra", "ip_bra", "remesa")
...
toc()
# note that these exogenous variables are specific to Parguay
saveRDS(extension_of_exo, file = "./data/extension_of_exo_us_ue_asia_bra_remesa.rds")
saveRDS(cv_extension_of_exo, file = "./data/cv_extension_of_exo_us_ue_asia_bra_remesa.rds")


# extension_of_exo <- readRDS(file = "./data/extension_of_exo_us_ue_asia_bra_remesa.rds")
# cv_extension_of_exo <- readRDS(file = "./data/cv_extension_of_exo_us_ue_asia_bra_remesa.rds")
...
write.xlsx(accumulated_passing_models, file = "./Excel_Output/Paraguay/All_accumulated_passing_models_paraguay_t165_lag_5.xlsx")
...
saveRDS(list(cv_size_2 = cv_size_2_per_row, cv_size_3 = cv_size_3_per_row, 
        ...
        file = "./data/forecast_models/all_paraguay_models_new_data_all_variables_restricted_combos_t165_lag_5.rds")

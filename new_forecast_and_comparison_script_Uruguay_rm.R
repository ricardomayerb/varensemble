...
data_object_per_new <- readRDS("./data/VAR_data_Uruguay.rds")
# print(colnames(data_object_per_new))
all_transformations <- readRDS("./data/target_transformation/target_transformation_Uruguay.rds")
target_transformation <- all_transformations$target_transformation
raw_data <- readRDS("./data/raw_VAR_data/raw_VAR_data_Uruguay.rds")
...
models_from_search_3 <- readRDS("./data/forecast_models/all_uruguay_models_new_data_all_variables_restricted_combos_t165_lag_3.rds")
models_from_search_4 <- readRDS("./data/forecast_models/all_uruguay_models_new_data_all_variables_restricted_combos_t165_lag_4.rds")
...
saveRDS(working_models, "./wm_ury_50.rds")
...
saveRDS(new_cv, "./cv50yearly_ury.rds")

new_cv <- readRDS("./cv50yearly_ury.rds")
...
write.xlsx(df_forecasts_all_models , file = "./Excel_Output/Uruguay/forecasts_all_models.xlsx")
...
write.xlsx(variables_by_h_freq_rel, file = "./Variable Count/Uruguay/variables_overall_freq_VAR30.xlsx")
write.xlsx(variables_by_h_freq_rel, file = "./Variable Count/Uruguay/variables_by_h_freq_VAR30.xlsx")
...
write.xlsx(count_year1, file = "./Variable Count/Uruguay/count_year1.xlsx")
count_year2 <- variables_by_h_freq_rel %>% dplyr::select(variable, n_2_y) %>% arrange(desc(n_2_y))
write.xlsx(count_year2, file = "./Variable Count/Uruguay/count_year2.xlsx")
...
write.xlsx(variables_by_h_freq_rel, file = "./Variable Count/Uruguay/variables_overall_freq_VAR10.xlsx")
write.xlsx(variables_by_h_freq_rel, file = "./Variable Count/Uruguay/variables_by_h_freq_VAR10.xlsx")
...
write.xlsx(yoy_table_top10, file = "./Excel_Output/Uruguay/Forecast summary/quarterly yoy top 10 variables.xlsx")
write.xlsx(annual_mean_top10_table, file = "./Excel_Output/Uruguay/Forecast summary/annual mean top 10 variables.xlsx")
write.xlsx(qy_means_y_fc_count_yr1, file = "./Excel_Output/Uruguay/Forecast summary/q_y_means_y1_fcs.xlsx")
...
saveRDS(object = list(forecast_df = df_forecasts_all_models,
        ...
        file = "./data/Forecast summary/Uruguay.rds")
...
componentes_demanda <- c("rpc", "rgc", "ri", "rx", "rm")
componentes_oferta <- c("primario", "manuf", "serv")
...
df_componentes_demanda_shares_y_contribucion <- df_componentes_demanda_shares_y_contribucion %>% mutate(contribucion_crecimiento_rpc_pib =  participacion_rpc_en_pib * rpc,
                                                                                                        ...
                                                                                                        contribucion_crecimiento_ri_pib =  participacion_ri_en_pib * ri,
...
df_componentes_oferta_shares_y_contribucion <- df_componentes_oferta_shares_y_contribucion %>% mutate(contribucion_crecimiento_primario_pib =  participacion_primario_en_pib * primario,

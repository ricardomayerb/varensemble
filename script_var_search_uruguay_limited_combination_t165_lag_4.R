...
target_transformation <- readRDS("./data/target_transformation/target_transformation_Uruguay.rds")
...
exogenous_variables <- c("emae_arg","act_eco_bra", "ip_us", "ip_bra", "ip_asia", "ip_ue")
...
toc()
saveRDS(extension_of_exo, file = "./data/extension_of_exo_us_ue_asia_bra_arg.rds")
saveRDS(cv_extension_of_exo, file = "./data/cv_extension_of_exo_us_ue_asia_bra_arg.rds")

# extension_of_exo <- readRDS(file = "./data/extension_of_exo_us_ue_asia_bra_arg.rds")
# cv_extension_of_exo <- readRDS(file = "./data/cv_extension_of_exo_us_ue_asia_bra_arg.rds")
...
write.xlsx(accumulated_passing_models, file = "./Excel_Output/Uruguay/All_accumulated_passing_models_uruguay_t165_lag_4.xlsx")
...
saveRDS(list(cv_size_2 = cv_size_2_per_row, cv_size_3 = cv_size_3_per_row, 
        ...
        file = "./data/forecast_models/all_uruguay_models_new_data_all_variables_restricted_combos_t165_lag_4.rds")
